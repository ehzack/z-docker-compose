...
var getRelativeWidth = function (i) {
  return deviceWidth * (i / 375);
};
var getRelativeHeight = function (i) {
  return deviceHeight * (i / 812);
};

var getRelativeWidth = function (i) {
  return deviceWidth * (i / 375);
};
var getResponsiveWidth = function (i) {
  return deviceWidth * (i / 100);
};

var getResponsiveHeight = function (i) {
...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? "#3A3C6C" : "#3A3C6C",
  brandInfo: "#EBB39D",
  brandSuccess: "#7CB880",
  brandDanger: "#DC8C8C",
  brandWarning: "#DC8C8C",
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? "#F8F8F8" : "#0069ff",
