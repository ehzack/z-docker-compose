...
import ListItemRate from 'view/shared/list/listItemRate';
import HandSVG from 'assets/3DElements/book.svg';
...
import Autocomplete from 'view/shared/items/Autocomplete';
class SelectFormItemNotFast extends Component {
  ...
  Fetchfn = async (value) => {
    return services.listAutocompleteDictionary(value, 'LANG');
  };
  render() {
    const {
      label,
