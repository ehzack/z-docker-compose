...
import actions from '../../../modules/recruiter/recruiterActions.js';
...
class Preferences extends Component {
  ...
  render() {
    return (
      ...
      >
        {this.buttonItem(
          i18n.t('user.recruiter.menu.preferences.myJobOffers'),
        ...
        {this.buttonItem(
          i18n.t('user.recruiter.menu.preferences.setting'),
          require('../../../../assets/icons/popular/more.png'),
          actions.DoListSettingsRecruiter(),
          6,
        )}
      </Animated.View>
    );
...
const mapStateToProps = (state) => ({
  ...
  loading: selectorsRecruiter.selectLoadingInit(state),
