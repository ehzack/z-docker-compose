...
import CandidatServices from '../../../modules/candidat/candidatService.js';
class PreferencesMain extends Component {
  ...
  componentDidMount() {
    CandidatServices.MatchCount().then((e) => {
...
const mapStateToProps = (state) => ({
  ...
  showSetting: selectorsCandidat.selectCandidatShwoSettings(state),
});
