...
var SwipeableItem = /** @class */ (function (_super) {
    ...
    SwipeableItem.prototype.render = function () {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(react_native_reanimated_1.default.View, { pointerEvents: swipeDirection === OpenDirection.LEFT ? "auto" : "none", style: [styles.underlay, { opacity: this.leftActive }] }, renderUnderlayLeft({
                item: item,
            ...
            react_1.default.createElement(react_native_reanimated_1.default.View, { pointerEvents: swipeDirection === OpenDirection.RIGHT ? "auto" : "none", style: [styles.underlay, { opacity: not(this.leftActive) }] }, renderUnderlayRight({
                item: item,
